...
use Gii\ModuleItem\Concerns\HasComposition;
use Gii\ModuleItem\Resources\Item\ShowItem;
...
class Item extends BaseModel {
    ...
    protected $list     = [
        'id', 'barcode', 'item_code', 'reference_type', 'reference_id', 'name', 'unit_id',
        'selling_price', 'cogs', 'min_stock', 'is_using_batch', 'status'
    ];

    protected $show     = [
        'last_selling_price', 'last_cogs', 'margin', 'tax',
        'netto', 'net_qty', 'net_unit_id'
    ];
    ...
    public function manufacture(){return $this->belongsToManyModel(
        'Manufacture','ModelHasManufacture',
        'model_id',$this->ManufactureModel()->getForeignKey()
